  ...
  const renderTournamentInfo = () => (
    <div className="flex justify-center items-center min-h-screen">
      <div className="max-w-5xl mx-auto">
        <Card className="p-8 sm:p-20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-0 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              ...
              <div
                key={item.label}
                className="rounded-lg bg-card text-card-foreground shadow-sm relative p-4 sm:p-20 sm:mb-16 overflow-hidden"
              >
